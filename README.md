...
MOSS는 인공지능 에이전트의 장기 기억 관리를 결정론적으로 통제하고 환각을 차단하여 안전한 일정 조작 및 기기 제어를 실현하기 위한 개념 검증용(PoC) 캘린더 에이전트 프로젝트입니다. 이 PoC에 대한 자세한 내용은 [비결정적 에이전트를 위한 결정론적 기억 제어: MOSS 아키텍처와 메모리 린터(Linter) 설계](https://www.joinc.co.kr/posts/detail?id=9) 포스트를 참고해주세요.
